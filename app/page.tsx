		...
		<>
			...
			<div className="min-h-screen flex items-center justify-center px-6">
				<div className="max-w-3xl text-center">
					...
					{/* Subtitle - F1 easter egg trigger */}
					<p
						ref={f1TriggerRef}
						className="text-lg md:text-xl text-[var(--color-text-secondary)] mb-4 opacity-0 animate-fade-in-up delay-200 cursor-default select-none"
						title="Click 3 times..."
					>
						大学生 / 开源爱好者 / F1爱好者
					</p>
